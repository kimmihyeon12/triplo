...
@Component({ selector: 'app-trip-header', imports: [SaveStatusComponent], changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './trip-header.html', styleUrl: './trip-header.css' })
