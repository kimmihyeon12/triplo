...
const PATHS: Record<string, string> = {
  ...
  // 날씨: 실제 제공자 연결 전이라 화면에서는 weather-unknown만 쓰인다.
  sun: 'M12 17a5 5 0 1 0 0-10 5 5 0 0 0 0 10zM12 2v2.5M12 19.5V22M4.2 4.2l1.8 1.8M18 18l1.8 1.8M2 12h2.5M19.5 12H22M4.2 19.8L6 18M18 6l1.8-1.8',
  cloud: 'M7 19h10.5a4 4 0 0 0 .4-8A6 6 0 0 0 6.6 9.4 3.8 3.8 0 0 0 7 19z',
  'cloud-sun': 'M8 5.5V3.5M4.2 6.7L2.8 5.3M4 11H2M11.8 6.7l1.4-1.4M8.6 6.1a4 4 0 0 0-2.4 6M9 20h8.5a3.5 3.5 0 0 0 .3-7A5 5 0 0 0 8.7 11 3.5 3.5 0 0 0 9 20z',
  rain: 'M7 15.5h10a3.8 3.8 0 0 0 .4-7.6A5.8 5.8 0 0 0 6.6 6.4 3.6 3.6 0 0 0 7 15.5zM8.5 18.5L7.5 21M12 18.5L11 21M15.5 18.5L14.5 21',
  snow: 'M7 15.5h10a3.8 3.8 0 0 0 .4-7.6A5.8 5.8 0 0 0 6.6 6.4 3.6 3.6 0 0 0 7 15.5zM8 19h.01M12 20.5h.01M16 19h.01',
  // 정보 없음: 구름 실루엣 + 물음표 자리의 점선 느낌 대신 가운데 대시 하나
  'weather-unknown': 'M7 18h10a3.8 3.8 0 0 0 .4-7.6A5.8 5.8 0 0 0 6.6 8.9 3.6 3.6 0 0 0 7 18zM10 14h4',
};
