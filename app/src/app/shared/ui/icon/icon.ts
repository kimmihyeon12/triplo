...
const PATHS: Record<string, string> = {
  ...
  // 공유: 위로 내보내는 화살표와 그것을 받치는 상자.
  share: 'M12 3.5v11M12 3.5l-3.5 3.5M12 3.5l3.5 3.5M5.5 13v6a1.5 1.5 0 0 0 1.5 1.5h10a1.5 1.5 0 0 0 1.5-1.5v-6',
  // 침대: 머리판·매트리스·베개·다리를 같은 기준선에 올렸다.
  bed: 'M3.5 19v-8.5M3.5 14.5h17M20.5 19v-4.5M3.5 10.5h11a6 6 0 0 1 6 6M7 13V11h3.5v2',
  // 집: 지붕 꼭짓점을 위 여백에 맞추고 벽·문을 같은 기준선에 세웠다.
  home: 'M3.5 10.2L12 3.5l8.5 6.7V19a1.5 1.5 0 0 1-1.5 1.5h-4v-6h-6v6H5A1.5 1.5 0 0 1 3.5 19z',
  // 지갑: 모서리를 넉넉히 굴린 몸통과 오른쪽 카드 칸.
  wallet:
    'M6 6.5h12a2.5 2.5 0 0 1 2.5 2.5v8a2.5 2.5 0 0 1-2.5 2.5H6A2.5 2.5 0 0 1 3.5 17V9A2.5 2.5 0 0 1 6 6.5zM15.5 11.5h5v3.5h-5a1.75 1.75 0 0 1 0-3.5z',
  ...
  'eye-off':
    'M3 3l18 18M10.6 10.6a3 3 0 0 0 4.2 4.2M9.9 5.2A10 10 0 0 1 12 5c6.5 0 10 7 10 7a17 17 0 0 1-3.2 4.2M6.6 6.6A17 17 0 0 0 2 12s3.5 7 10 7c1.4 0 2.7-.3 3.8-.7',
  refresh: 'M21 12a9 9 0 1 1-2.6-6.4M21 3v6h-6',
  // 달력: 모서리를 둥글리고 머리줄 아래를 본문 영역으로 비웠다.
  calendar:
    'M5 5.5h14a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-13a1 1 0 0 1 1-1zM4 10h16M8 3.5v4M16 3.5v4',
  ...
  sparkle:
    'M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8L12 3zM18 16l.7 2.1L21 19l-2.3.9L18 22l-.7-2.1L15 19l2.3-.9L18 16z',
  ...
  // 확성기: 공지사항. 소리가 퍼지는 방향을 오른쪽으로 두어 알림(종)과 구분한다.
  megaphone:
    'M3.5 10.5v3a1.5 1.5 0 0 0 1.5 1.5h2l6 4.5V6L7 10.5H5a1.5 1.5 0 0 0-1.5 1.5zM17 9a4 4 0 0 1 0 6M6.5 15v4.5h2.5',
  // 봉투: 문의하기. 덮개 선을 안쪽으로 접어 읽지 않은 편지로 보이게 했다.
  mail: 'M4 6.5h16a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-9a1 1 0 0 1 1-1zM3.5 7.5l8.5 6 8.5-6',
  // 종: 알림. 추까지 그려 울리는 것임을 분명히 한다.
  bell: 'M18 9a6 6 0 1 0-12 0c0 5-2 6.5-2 6.5h16S18 14 18 9zM13.7 19a2 2 0 0 1-3.4 0',
  // 문서: 개인정보 처리방침·이용약관. 오른쪽 위 모서리를 접었다.
  document:
