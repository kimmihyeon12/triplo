...
export const BUTTON_CLASSES = String.raw`
  btn relative inline-flex items-center justify-center gap-1.5 min-h-10 rounded-control border
  border-border bg-panel text-ink font-semibold text-14 no-underline py-0 px-4
  [transition:background-color_var(--dur)_var(--ease-out),_color_var(--dur)_var(--ease-out)]
  ...
  [.action-bar\_\_inner_&]:min-h-12.5 [.action-bar\_\_inner_&]:text-15
  [.action-bar\_\_inner_&]:rounded-control-lg
`;
